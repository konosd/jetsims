from utils import *
# from utils_one_loading_site import * # Uncomment if we want only one loading site.
...
parser.add_argument('--broad-loading-range', default=700)
...
dir_name ='20_reps_lr' + str(args_trml.loading_range) + '_sep' + str(args_trml.separation) + '_lif' + str(args_trml.lifetime) + \
...
root = '/rds/general/user/kn119/home/loop_extrusion/probabilistic_loading/'
...
broad_loading_range = int(args_trml.broad_loading_range)//2
...
bLS = (N1//2 - broad_loading_range, N1//2 + broad_loading_range)
...
args["Probabilistic_Loading"] = True
...
with h5py.File(os.path.join(root,myfile_name), mode='w') as myfile:
    ...
    myfile.attrs["bLS_one"] =args[ 'bLS'][0]
    myfile.attrs["bLS_two"] =args[ 'bLS'][1]
