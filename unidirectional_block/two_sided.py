...
root = '/rds/general/user/kn119/home/loop_extrusion/jet_angles/'
...
my_plot_title = 'Two sided'
TADs = [int(args_trml.left_ctcf)-50*i for i in range(int(args_trml.enforce_ctcf))]+[int(args_trml.right_ctcf)+50*i for i in range(int(args_trml.enforce_ctcf))]
